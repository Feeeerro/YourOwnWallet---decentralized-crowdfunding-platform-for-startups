            ...
            <div style={styles.card}>
                ...
                <form onSubmit={handleSubmit}>
                    <div style={styles.field}>
                        ...
                        <input name="campaign_name" value={formData.campaign_name} onChange={handleChange} style={styles.input} required />
                    </div>
                    <div style={styles.field}>
                    ...
                    <div style={styles.row}>
                        <div style={styles.field}>
                            ...
                            <input type="number" step="0.01" min="0.01" name="target" value={formData.target} onChange={handleChange} style={styles.input} required />
                        </div>
                        <div style={styles.field}>
                    ...
                    <div style={styles.field}>
                        <label>Startup</label>
                        <select name="startup" value={formData.startup} onChange={handleChange} style={styles.input} required>
                    ...
                    <p style={styles.note}>
                        * Creating a campaign will automatically deploy smart contracts on the blockchain. This may take a few seconds.
                    </p>
                </form>
            </div>
        </div>
